...
<div id="carouselSlider" class="carousel slide">
	<div class="carousel-inner" style=" padding: 55px; margin-top: -54px; border: radius 10px; margin-right:auto; ">
...
<section class="" style="width:100%; height: 600px;">
	<div class="container" style="background-color: #150544; width:970px; height:420px; border-top-right-radius: 50px; margin-right:auto;">
		<h2 class="about" style="color:white; font-family: poppins; margin-left:100px;">ABOUT US</h2>
		<br><br>
		<p style="color: white; font-family:poppins; margin: right 50%; margin-left:420px;">INTI - CSIRT melaksanakan layanan tanggap insiden siber , berupa :
...
<section class="" style="width:100%; color: white; height: 700px; margin-top:220px;">
	<div class="container">
		<center>
			...
			<h2 style="color: black;">Why Should Choose Us?</h2>
		</center>
