...
<section class="" style="width:100%; height: 600px;">
	<div class="container" style="background-color: #150544; width:970px; height:510px; border-top-right-radius: 40px; margin-right:35px;">
		...
		<p style="color: white; font-family:poppins; margin: right 50%; margin-left:420px; margin-top:55px;">
			<img src="assets/images/logo-gembok.png" style="width:500px; margin-left: -550px; margin-top:-90px;">
		</p>
