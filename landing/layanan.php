...
<head>
    ...
    <link rel="stylesheet" href="<?php echo base_url() ?>assets-landing/css/stylel.css">
    <!-- Style.css -->
...
<section class="rounded-4 konten">
    <div class="container">
        ...
        <p>
            <br><br>
        <h3 class="p2">4. Pemberitahuan Hasil Pengamatan Potensi Ancaman
        </h3>
        <p class="p2">
        ...
        <p>
            <br><br>
        <h3 class="p1">5. Pendeteksian Serangan
        </h3>
        <p class="p1">
        ...
        <p>
            <br><br>
        <h3 class="p2">6. Pembangunan Kesadaran dan Kepedulian Terhadap Keamanan Siber
        </h3>
        <p class="p2">
...
<footer class="footer" style="background:#150544; padding:10px; text-align:center; height:100px;">
    <p class="pooter" style="margin-top: 28px; color:white; font-family:poppins;">Copyright &copy; 2022 INTI-CSIRT</p>
</footer>
</body>
