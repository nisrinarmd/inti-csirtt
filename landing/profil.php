...
<section class="" style="width:100%; height: 600px;">
    <div class="container" style="background-color: #150544; width:970px; height:110%; border-top-right-radius: 40px; margin-right:110px; margin-top:80px;">
        ...
        <p style="color: white; font-family:poppins; margin: right 50%; margin-left:420px; margin-top:150px;"><img src="<?php echo base_url() ?>assets/images/logo-gembok.png" style="width:480px; margin-left: -550px; margin-top:-90px;">
        </p>

        <p style="color: white; font-family:poppins; margin: right 50%; margin-left:420px; margin-top:-530px;">Tim Tanggap Insiden Siber/Computer Security Incident Response<br>Team PT Industri Telekomunikasi Indonesia (INTI-CSIRT) ditetapkan<br>Oleh PT INTI (Persero) melalui
            Surat Keputusan Direksi No: KD.058/<br>KP.14/020800/2022. Vice President Information Technology & Digital<br>Service ditunjuk sebagai Ketua INTI-CSIRT dan ditugaskan untuk<br>
            melaksanakan perumusan, perencanaan, pembangunanan,<br>pengoperasian, pengembangan, pengawasan, evaluasi<br>dan anggaran terkait INTI-CSIRT.<br><br>INTI-CSIRT melaksanakan layanan tanggap insiden siber, berupa:<br><br>
            Layanan reaktif, yaitu layanannyang terkait dengan kebutuhan<br>melakukan respon terhadap insiden siber termasuk penangkalan,<br>penindakan dan pemulihan siber.<br>
            Layanan proaktif, yaitu layanan yang mendeteksi dan mencegah<br>serangan siber sebelum ada dampak nyata.<br>
            INTI-CSIRT direncanakan akan resmi di-launching pada bulan Juli<br>2022 dan setiap pengguna sistem elektronik di lingkungan PT<br>Industri Telekomunikasi Indonesia (PT INTI) dan anak<br>perusahaannya merupakan konstituen dari INTI-CSIRT.
        </p>
