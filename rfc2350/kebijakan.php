...
<section class="" style="width:100%; height: 900px;">
    <div class="container" style="background-color: #150544; width:970px; height:700px; border-top-right-radius: 40px; margin-right:35px;">
        <h1>Kebijakan</h1>
        <p style="color: white; font-family:poppins; margin: right 50%; margin-left:420px; margin-top:60px;"><img src="<?php echo base_url(); ?>assets/images/dokpen.png" style="width:400px; margin-left: -530px; margin-top:-90px;">
        </p>
        ...
        <h4>1.Jenis-jenis Insiden dan Tingkat/Level Dukungan</h4>
        <h5>INTI-CSIRTmemiliki otoritas untuk menangani insiden yaitu :
            <br>1. Web Defacement;
            <br>2. DDOS;
            <br>3. Malware;
            <br>4. Phising;
        ...
        <h4>2.Kerja sama, Interaksi dan Pengungkapan <br>Informasi/data</h4>
        <h5>INTI-CSIRT akan melakukan kerjasama dan <br>berbagi informasi dengan CSIRT atau organisasi <br>lainnya dalam lingkup keamanan siber. Seluruh <br>informasi yang diterima oleh INTI-CSIRT akan <br>dirahasiakan.</h5>
        <h4>3.Komunikasi dan Autentikasi</h4><br>
        <h5>Untuk komunikasi biasa INTI-CSIRT dapat <br>menggunakan alamat e-mail tanpa enkripsi data <br>(e-mail konvensional) dan telepon. Namun, untuk <br>komunikasi yang memuat informasi sensitif/terbatas/<br>rahasia dapat menggunakan enkripsi PGP pada e-mail.</h5>
    </div>
</section>
<footer>
    <div class="footer">
